...
const Index = () => {
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 right-20 w-[500px] h-[500px] bg-secondary/20 rounded-full blur-[100px] animate-float" style={{
        animationDelay: "1s"
      }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/10 rounded-full blur-[120px] animate-float" style={{
        animationDelay: "2s"
      }} />
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-center mb-20 animate-fade-in">
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-8 tracking-tight">
            <span className="gradient-text drop-shadow-lg">Bharat Explore Bot</span>
          </h1>
          <p className="text-xl md:text-3xl text-muted-foreground/90 max-w-3xl mx-auto leading-relaxed font-light">Explore every corner of India with your personal AI pathfinder!</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto mb-20">
          {/* Chatbot Card */}
          <Link to="/chat">
            <Card className="glass-card border-primary/30 p-10 cursor-pointer group hover:scale-[1.02] transition-all duration-500 hover:neon-glow animate-fade-in relative overflow-hidden h-full" style={{
            animationDelay: "0.1s"
          }}>
          ...
          <Link to="/trip-planner">
            <Card className="glass-card border-accent/30 p-10 cursor-pointer group hover:scale-[1.02] transition-all duration-500 hover:neon-glow animate-fade-in relative overflow-hidden h-full" style={{
          ...
          {/* Map Card */}
          <Link to="/map">
            <Card className="glass-card border-secondary/30 p-10 cursor-pointer group hover:scale-[1.02] transition-all duration-500 hover:neon-glow-secondary animate-fade-in relative overflow-hidden h-full" style={{
            animationDelay: "0.2s"
          }}>
              ...
              <div className="text-center relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-3 gradient-text"> Map</h3>
                <p className="text-muted-foreground/90 leading-relaxed text-sm">Explore map of
Indian states </p>
